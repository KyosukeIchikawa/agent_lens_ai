...
export default function IntroductionPage() {
  return (
    <article className="prose max-w-none">
      <SectionHeader title="Introduction" subtitle="導入" sectionNumber="I" />
      ...
      <SubsectionContainer title="オープンワールド適応の課題" id="open-world-challenges">
        ...
        <p>オープンワールド環境における適応には、以下の主要な課題があります：</p>

        <ul>
          <li>
            <strong>新規性への迅速な適応</strong>
            ：予期せぬ環境変化に対して素早く新しい戦略を学習・適用する必要があります。
          </li>
          <li>
            <strong>サンプル効率</strong>
            ：実世界では大量の試行錯誤は実用的でないため、限られた経験から効率的に学習する能力が求められます。
          </li>
          <li>
            <strong>シンボリックな理解と低レベルの行動の統合</strong>
            ：高レベルのシンボリック推論と低レベルの連続的な行動制御を効果的に結びつける必要があります。
          </li>
        </ul>
      </SubsectionContainer>

      <SubsectionContainer title="既存手法の限界" id="limitations-of-existing-approaches">
        <p>これらの課題に対処するための既存アプローチには、以下のような限界があります：</p>

        <ul>
          <li>
            <strong>純粋なシンボリックアプローチ</strong>
            ：事前に定義された環境モデルに依存しており、予期せぬ変化に対応できません。
          </li>
          <li>
            <strong>純粋なデータ駆動アプローチ</strong>
            ：大量のデータを必要とし、効率的な適応が難しいという問題があります。
          </li>
          <li>
            <strong>ハイブリッドアプローチ</strong>
            ：既存のハイブリッドアプローチでは、効率的な探索と知識利用のバランスが十分に取れていません。
          </li>
        </ul>
      ...
      <SubsectionContainer title="本研究の提案：好奇心駆動型想像力" id="our-approach">
        <p>
          本研究では、これらの有望だが別々に発展してきたアプローチを統合する新しいフレームワーク「好奇心駆動型想像力（Curiosity-Driven
          Imagination, CDI）」を提案します。CDIは以下の要素を組み合わせたものです：
        </p>

        <ol>
          <li>
            <strong>シンボリック抽象化</strong>
            ：低レベルの状態遷移をシンボリックオペレータとして抽象化
          </li>
          <li>
            <strong>内発的好奇心モジュール（ICM）</strong>：予測誤差に基づいた好奇心駆動型探索
          </li>
          <li>
            <strong>想像的プランニング</strong>：学習したオペレータを活用した高レベル計画生成
          </li>
          <li>
            <strong>計画報酬マシン（PRM）</strong>：計画に基づく報酬の高密度化
          </li>
        </ol>
      ...
      <SubsectionContainer title="主要な貢献" id="contributions">
        <p>本研究の主要な貢献は以下の通りです：</p>

        <ol>
          <li>
            <strong>シンボリックオペレータの自動学習</strong>
            ：エージェントが環境との相互作用を通じて新しいオペレータを自動的に学習し、それらを用いて効率的な計画生成を行うメカニズムを提案
          </li>
          <li>
            <strong>好奇心と想像力の統合</strong>
            ：好奇心駆動型探索（ICM）とシンボリック計画（PRM）を統合することで、効率的な環境探索と経験の活用を実現
          </li>
          <li>
            <strong>実験的検証</strong>
            ：5種類の新規性シナリオにおいてBi-Modelの有効性を実証し、比較手法に対する優位性を示す
          </li>
        </ol>

        <p>
          実験結果は、Bi-ModelがRoboSuiteの「Pick and Place」タスクにおいて、複雑な新規性（Light
          OffやLocked）に対して特に優れた適応能力を示すことを実証しています。Bi-Modelは最高の成功率を達成すると同時に、比較手法よりも40%以上速く適応することができました。
        </p>
      </SubsectionContainer>
