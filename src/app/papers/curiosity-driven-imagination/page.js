    ...
    <article className="prose prose-lg max-w-none">
      ...
      <SectionContainer title="概要" >
        <p>
          ...
          本論文では、好奇心駆動型探索と記号的想像力を組み合わせた新しいアプローチ「Curiosity-Driven Imagination (CDI)」を提案します。
        </p>

        主要な貢献は以下の通りです：
        <ul>
          <li>
            <strong>Bi-Modelアーキテクチャ</strong>: 好奇心駆動型探索からの経験と記号的想像力を統合し、新しい状況に効果的に適応するためのアーキテクチャを提案。
          </li>
          <li>
            <strong>自己教示型オペレータ学習</strong>: 好奇心によって駆動される探索を通じて、新しいオペレータ（行動の組み合わせ）を自動的に発見し、それを用いて行動を改善。
          </li>
          <li>
            <strong>実験による有効性の実証</strong>: robosuite環境で実施した実験により、提案手法が事前に遭遇したことのない新しい状況に効果的に適応できることを実証。
          </li>
        </ul>
      ...
      <AITips title="なぜ好奇心と想像力の組み合わせが重要なのか？">
        ...
        <ul>
          <li><strong>好奇心駆動型探索</strong>：ドアノブを回す、押す、引くなど、様々な操作を試してみる</li>
          <li><strong>記号的想像力</strong>：「ドアノブを回してから押す」という一連の動作を1つのまとまり（オペレータ）として記憶し、似たような状況で再利用する</li>
        </ul>
        <p>
