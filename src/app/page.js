        ...
        <section className="py-20 px-4">
          <div className="container mx-auto">
            ...
            {featuredPapers.length > 0 ? (
              ...
              >
                <motion.div variants={fadeInUp} className="md:w-1/2 lg:w-2/5">
                  {/* 最新の論文を1つ大きく表示 */}
                  {featuredPapers[0] && (
                    <motion.div
